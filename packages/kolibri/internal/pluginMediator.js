      ...
      return new Promise((resolve, reject) => {
        ...
        if (!kolibriModuleName) {
          ...
          Promise.all(urls.map(scriptLoader))
            ...
            .then(() => {
              // CSS direction switching is now handled by the RTL manager via webpack runtime,
              // so we no longer need to manually track script/link tags.
              // Just resolve the component when the module is registered.
