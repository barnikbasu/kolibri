...
class DiskChannelResourceExportManager(JobProgressMixin):
    ...
    def initialize_progress_tracking(self):
        ...
        """
        file_size = (
            self.content_bytes_to_transfer if self.export_content else self.channel_db_size
        )
    ...
    def _export_file(self, f):
        ...
        with transfer.FileCopy(srcpath, dest, cancel_check=self.is_cancelled) as copy:
