...
.. code-block:: python
  ...
  from kolibri.core.utils.annotation import annotate_array_aggregate
...
.. code-block:: python
  ...
  from kolibri.core.auth.filters import KolibriAuthPermissionsFilter
  from kolibri.core.utils.annotation import annotate_array_aggregate
      ...
      def consolidate(self, items, queryset):
          ...
          if items:
              ...
              adhoc_assignments = LessonAssignment.objects.filter(
                  lesson_id__in=lesson_ids,
                  collection__kind=collection_kinds.ADHOCLEARNERSGROUP
              )
